"""
LFM2-VL-1.6B Vision-Language Model Wrapper

HuggingFace: https://huggingface.co/LiquidAI/LFM2-VL-1.6B

LFM2-VL-1.6B uses SigLIP2 NaFlex (400M params, 1152 hidden size) as vision encoder.
...
class LFM2VL16B(BaseVLM):
    """LFM2-VL-1.6B wrapper."""
    
    MODEL_ID = "LiquidAI/LFM2-VL-1.6B"
    MODEL_NAME = "lfm25vl_1b"
    HUGGINGFACE_URL = "https://huggingface.co/LiquidAI/LFM2-VL-1.6B"
    VISION_HIDDEN_SIZE = 1152  # SigLIP2 NaFlex 400M
...
LFM25VL16B = LFM2VL16B


def load_model(device: str = "cuda") -> LFM2VL16B:
    """Load LFM2-VL-1.6B model."""
    return LFM2VL16B(device=device)
